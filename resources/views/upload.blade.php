<!DOCTYPE html>
<head>
    <title>Admin Assignments Upload</title>
    <meta charset="utf-8" />
...
<body>
  ...
  <form action="{{route('assignmentsupload')}}" enctype="multipart/form-data" method="POST">
  @csrf
   <!-- Validation Errors -->
   <div style="color:red;font-weight:bold;font-family:san-serif">
   <x-auth-validation-errors class="mb-4" :errors="$errors" />
</div>
    <h3 style="color:white">Please upload your assignment Question(s). Only upload question(s) in PDF Format.</h3>
        ...
        <!--notes-->
        <p style="color:royablueblue"> This assignment will appear in assignments section on students dashboard</p>
